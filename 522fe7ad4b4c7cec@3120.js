export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([["topcourses_newdate_nousgbc_wpvd-2.csv",new URL("./files/97c52c70471fd5eea435fe8873bb64869ffb37696d23033708af634093cf9c045343b33e696cdc6da1e0eed5702b6c6595615a6d27e1e9cb185b8b849ece0a67",import.meta.url)]]);
  main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
  main.variable(observer()).define(["md"], function(md){return(
md`# Popular Education@USGBC Courses Over Time

This chart animates the top courses by course title and provider between 2014 and 2021. The data comes from downloaded course completion records (education_log_extended).  Please note that it might be possible that expired courses may have been removed from the totals.`
)});
  main.variable(observer("data")).define("data", ["FileAttachment"], function(FileAttachment){return(
FileAttachment("topcourses_newdate_nousgbc_wpvd-2.csv").csv({typed: true})
)});
